...
export const siteConfig = {
  ...
  description:
    "An interactive browser-based AR experience that uses real-time hand and face tracking to create a visually immersive smoking simulation, combining procedural smoke, interactive controls, and a Y2K/PS2-inspired game interface.",
  image: "/images/projects/vapor-exe.png",
  technologies: [
    "React",
    "TypeScript",
    "Vite",
  ...
  highlights: [
    ...
    "Interactive cigarette and burn system",
    "Procedural smoke simulation",
    "Real-time smoke and ash physics",
    "Multiple visual smoke presets",
    "Adjustable intensity, wind, and sensitivity",
    "Y2K / PS2-inspired interactive HUD",
    "Responsive desktop and mobile experience",
    "Local camera processing for privacy",
    "Performance optimization for mobile devices",
    "Vercel deployment",
  ],
  github: "https://github.com/AboobakerSiddique/Vapor.exe",
  live: "https://vapor-exe-cyan.vercel.app/",
  featured: false,
},
    {
  ...
  highlights: [
    ...
    "Real-time feedback retrieval and display",
    "Swagger API documentation",
    "End-to-end testing and accessibility validation",
    "Vercel + Render deployment",
  ],
  github: "https://github.com/AboobakerSiddique/event-feedback-management-system",
  live: "https://event-feedback-management-system.vercel.app/",
  featured: false,
},
{
  id: "fitscope",
  number: "07",
  title: "FITSCOPE — AI RESUME ANALYZER",
  category: "GENERATIVE AI",
  description:
    "An AI-powered Resume Analyzer built with Next.js, FastAPI, LangChain, Gemini, and Pydantic. Fitscope compares a candidate's resume against a target job description to generate a structured compatibility report with skill gaps, strengths, weaknesses, match scoring, and requirement-level analysis.",
  image: "/images/projects/fitscope.png",
  technologies: ["PYTHON", "FASTAPI", "LANGCHAIN", "GEMINI", "PYDANTIC", "NEXT.JS"],
  highlights: [
    "Resume & Job Description PDF Analysis",
  ...
  github: "https://github.com/AboobakerSiddique/AI-Resume-Analyzer",
  live: "https://frontend-ten-fitscope.vercel.app/",
  featured: false,
},
  ] satisfies Project[],
