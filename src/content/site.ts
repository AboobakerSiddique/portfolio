...
export const siteConfig = {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "A secure REST API built with FastAPI and SQLAlchemy featuring authentication, JWT-protected routes, password hashing, validation, and CRUD operations.",
      image: "/images/projects/task-api.png",
      technologies: ["PYTHON", "FASTAPI", "SQLALCHEMY", "SQLITE", "JWT", "BCRYPT"],
      highlights: [
